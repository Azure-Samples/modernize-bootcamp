...
namespace eShopLite.AdminFx
{
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            var authService = new LegacyAuthService(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, settings.UsersFilePath));
            ...
            var productApiClient = new ProductApiClient(settings.ProductsApiBaseUrl, settings.ProductsApiTimeoutSeconds, settings.ProductsApiKey);
        ...
        private static AdminSettings LoadSettings()
        {
            return new AdminSettings
            {
                ...
                UsersFilePath = ConfigurationManager.AppSettings["UsersFilePath"] ?? @"Data\users.json",
                ProductsApiKey = ConfigurationManager.AppSettings["ProductsApiKey"] ?? string.Empty
            };
        }
    }
}
