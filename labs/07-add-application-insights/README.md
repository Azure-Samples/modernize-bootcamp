...
1. Open the storefront URL and use it like a customer would: browse the catalog, search, open a product, add something to the cart, sign in with one of the [demo logins](../../docs/logins.md).
